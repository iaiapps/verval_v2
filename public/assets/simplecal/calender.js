...
function dates(tags) {
    ...
    var multiple_list = document.getElementsByClassName("simple-dates");
...
function days(tags) {
    ...
    //You can call the class multiple times
    var multiple_list = document.getElementsByClassName("simple-days");
    for (i = 0; i < multiple_list.length; i++) {
...
function short_days(tags) {
    ...
    //You can call the class multiple times
    var multiple_list = document.getElementsByClassName("simple-short-days");
    for (i = 0; i < multiple_list.length; i++) {
        multiple_list[i].innerHTML = days;
    }
}
...
function months(tags) {
    ...
    //You can call the class multiple times
    var multiple_list = document.getElementsByClassName("simple-months");
    for (i = 0; i < multiple_list.length; i++) {
...
function short_months(tags) {
    ...
    //You can call the class multiple times
    var multiple_list = document.getElementsByClassName("simple-short-months");
    for (i = 0; i < multiple_list.length; i++) {
        multiple_list[i].innerHTML = months;
    }
}
...
function years(tags, startY, endY) {
    ...
    //You can call the class multiple times
    var multiple_list = document.getElementsByClassName("simple-years");
    for (i = 0; i < multiple_list.length; i++) {
